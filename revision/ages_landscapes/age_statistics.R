...
write.table(all_models_class, file = "/home/gavin/genome/genome/repeats_12-18-18/revisions/kimura_distances_lm_ac_effect_sizes/kimura_distances_models_class.tsv",row.names = FALSE, quote = FALSE, sep = "\t")
...
write.table(all_models_order, file = "/home/gavin/genome/genome/repeats_12-18-18/revisions/kimura_distances_lm_ac_effect_sizes/kimura_distances_models_order.tsv",row.names = FALSE, quote = FALSE, sep = "\t")
...
write.table(all_models_superfamily, file = "/home/gavin/genome/genome/repeats_12-18-18/revisions/kimura_distances_lm_ac_effect_sizes/kimura_distances_models_superfamily.tsv",row.names = FALSE, quote = FALSE, sep = "\t")
...
write.table(all_models_family, file = "/home/gavin/genome/genome/repeats_12-18-18/revisions/kimura_distances_lm_ac_effect_sizes/kimura_distances_models_family.tsv",row.names = FALSE, quote = FALSE, sep = "\t")
...
rep_data <- read.table("/home/gavin/genome/genome/repeats_12-18-18/revisions/05_global_kimura_distance_landscape/all.tsv", sep="\t", header=TRUE)
...
rep_data <- read.table("/home/gavin/genome/genome/repeats_12-18-18/revisions/all_cluster_insertion_age_abundance.tsv", sep="\t", header=TRUE)
...
rep_data <- read.table("/home/gavin/genome/genome/repeats_12-18-18/revisions/kimura_distances.tsv", sep="\t", header=TRUE)
