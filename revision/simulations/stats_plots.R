...
#get data in there
rep_dat <- read.table("/home/gavin/genome/genome/repeats_12-18-18/revisions/simulations_12-20-19/work_on_macbook_12-22-19/06_SIMULATIONS_DEC_27_2019/local_00_awk_TE_sites/all_dec_27_simulations_TE_sites.tsv", sep="\t", header=TRUE)
...
#get data in there
rep_dat <- read.table("/home/gavin/genome/genome/repeats_12-18-18/revisions/simulations_12-20-19/work_on_macbook_12-22-19/local_00_awk_TE_sites_early_dec_2019_simulations/early_dec_simulations_TE_sites.tsv", sep="\t", header=TRUE)
...
#write the data to a table
write.table(stat_df, file = "/home/gavin/genome/genome/repeats_12-18-18/revisions/simulations_12-20-19/work_on_macbook_12-22-19/local_00_awk_TE_sites_early_dec_2019_simulations/early_dec_simulations_effect_sizes_wilcox_tests_12-27-19",row.names = FALSE, quote = FALSE, sep = "\t")
...
ggsave("00_DOM_NEUTRAL.pdf", width= 5,height=5,units='in')
...
ggsave("01_NO_DOM_NEUTRAL.pdf", width= 5,height=5,units='in')
...
ggsave("02_DOM_SEL_ALL.pdf", width= 5,height=5,units='in')
...
ggsave("03_NO_DOM_SEL_ALL.pdf", width= 5,height=5,units='in')
...
ggsave("04_DOM_SEL_ALL_WEAK.pdf", width= 5,height=5,units='in')
...
ggsave("05_NO_DOM_SEL_ALL_WEAK.pdf", width= 5,height=5,units='in')
...
ggsave("06_DOM_SEL_ALL_WEAK_POS_MUT.pdf", width= 5,height=5,units='in')
...
ggsave("07_NO_DOM_SEL_ALL_WEAK_POS_MUT.pdf", width= 5,height=5,units='in')
...
ggsave("08_DOM_SEL_ARM_WEAK_CENTER_STRONG.pdf", width= 5,height=5,units='in')
...
ggsave("09_NO_DOM_SEL_ARM_WEAK_CENTR_STRONG.pdf", width= 5,height=5,units='in')
...
ggsave("12_DOM_SEL_CENTR_WEAK.pdf", width= 5,height=5,units='in')
...
ggsave("13_NO_DOM_SEL_CENTR_WEAK.pdf", width= 5,height=5,units='in')
...
ggsave("00_DOM_sel_all_WEAK_SEL_-0.0002.pdf", width= 5,height=5,units='in')
...
ggsave("01_DOM_sel_all_WEAK_SEL_-0.0005.pdf", width= 5,height=5,units='in')
...
ggsave("02_DOM_sel_all_WEAK_SEL_-0.001.pdf", width= 5,height=5,units='in')
...
ggsave("03_DOM_sel_all_WEAK_SEL_-0.0015.pdf", width= 5,height=5,units='in')
...
ggsave("04_DOM_sel_all_WEAK_SEL_-0.002.pdf", width= 5,height=5,units='in')
...
ggsave("05_no_dom_sel_all_weak_SELFING.pdf", width= 5,height=5,units='in')
...
ggsave("06_DOM_sel_all_WEAK_SELFING.pdf", width= 5,height=5,units='in')
...
ggsave("07_no_dom_sel_arm_weak_Center_Strong_SELFING.pdf", width= 5,height=5,units='in')
...
ggsave("08_DOM_sel_arm_WEAK_center_Strong_SELFING.pdf", width= 5,height=5,units='in')
...
ggsave("09_no_dom_sel_arm_weak_Center_Strong-LOSS_0.5BROKEN.pdf", width= 5,height=5,units='in')
...
ggsave("10_DOM_sel_arm_WEAK_center_Strong_LOSS_0.5BROKEN.pdf", width= 5,height=5,units='in')
...
ggsave("10_DOM_SEL_ARM_WEAK_CENTER_STRONG_LOSS.pdf", width= 5,height=5,units='in')
...
ggsave("11_NO_DOM_SEL_ARM_WEAK_CENTER_STRONG_LOSS.pdf", width= 5,height=5,units='in')
...
ggsave("/home/gavin/genome/genome/repeats_12-18-18/revisions/simulations_12-20-19/early_dec_neutral_simulations_over_time.png",width=6,height=7,units="in")
